...
const PunchLogSection = React.memo(({ apiAttData, page, setPage, rowsPerPage, setRowsPerPage, isLoading }) => {
	...
	return (
		<>
			<div className="panel bg-white !mx-6">
				<div>
					<div className="left h3 flex items-center">
					...
					<NavLink
						to="/punch"
						className="right flex items-center text-neutral-400 hover:text-neutral-600 me-3 transition-colors aa_wrapper">
						前往打卡
